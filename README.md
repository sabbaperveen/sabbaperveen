...
<h3 align="left">Security Tools & Platforms:</h3>

- **Splunk** – SIEM, log analysis, and SOAR integrations  
- **IBM QRadar** – Threat detection and correlation rules  
- **Wazuh** – Open-source SIEM and endpoint monitoring  
- **Nmap** – Network scanning and reconnaissance  
- **Wireshark** – Packet analysis and network troubleshooting  
- **Nessus / Tenable** – Vulnerability scanning and risk management  
